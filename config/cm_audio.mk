...
ALARM_PATH := vendor/ackdp/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/ackdp/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/ackdp/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/ackdp/prebuilt/common/media/audio/ui
